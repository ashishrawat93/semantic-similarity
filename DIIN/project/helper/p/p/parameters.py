...
models = ['attmix_CNN', "DIIN", "my_model"]
def types(s):
...
pa("model_type", choices=models, type=types, default= "my_model", help="Give model type.")
...
pa("--ckptpath", type=str, default="")
pa("--logpath", type=str, default="")
pa("--tbpath", type=str, default="", help='tensorboard path')
